...
export function Dashboard() {
  ...
  const handleAnalyze = useCallback(async () => {
    ...
    try {
      ...
      let firstSummary = allResults[0].summary;
      let firstPlantType = allResults[0].plantType;
      ...
      // Removed setView("home") to stay on the Detect tab
    } catch (err: any) {
  ...
  const renderDetect = () => (
    <div className="space-y-6 animate-in fade-in-0 duration-300">
      ...
      <DetectionTab result={detectionForUi} isLoading={isAnalysisLoading} images={images} />
    </div>
  );
