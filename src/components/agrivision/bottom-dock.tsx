...
import { Camera, LineChart, Sparkles, CalendarDays, History as HistoryIcon } from "lucide-react";

import { cn } from "@/lib/utils";

export type DockView = "detect" | "plan" | "market" | "history" | "advisor";
...
const items: Array<{ id: DockView; label: string; icon: ComponentType<{ className?: string }> }> = [
  ...
  { id: "advisor", label: "Assistant", icon: Sparkles },
];
